...
#ifdef _MSC_VER
// FltkÎ•?dynamic liking?†Í∫ºÎ©?FL_DLL???îÌåå???òÏãú?? 
// - mainlibPython???∞Îäî Í≤ΩÏö∞??ÎßÅÌÅ¨?êÎü¨Í∞Ä ?òÎäîÍ≤ΩÏö∞Î•??úÏô∏?òÍ≥†??FL_DLL ÎπÑÏ∂î.
#define FL_DLL 
...
namespace Msg
{
	void verify(bool bExpression, const char*, ...);// release?êÏÑú???ÜÏñ¥ÏßÄÏßÄ ?äÎäî verifyÎ•??òÍ≥† ?∂Ï?Í≤ΩÏö∞ ?¨Ïö©.
	...
	public:
		...
		// ?ÑÏßÅ Íµ¨ÌòÑ?àÎê®. ?¨Ïö©?êÏóêÍ≤?yes or noÎ¨ºÏñ¥Î≥¥Îäî Í∏∞Îä•.

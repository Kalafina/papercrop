...
public:
	...
	void SetPixel(float x, float y, CPixelRGB8 color); ///< (0,1)좌표계에서 정의된 점을 그린다. -> 느리다는 점에 주의. 좀더 빠르게 점을 찍고 싶은 경우 CColorPixelPtr클래스 사용. 사용법은 ImagePixel.cpp의 SetPixel함수 참고

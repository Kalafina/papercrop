...
#define __POPPLER_TYPE_ENUMS_H__ 1
...
#define POPPLER_TYPE_ANNOT_TEXT_ICON (poppler_annot_text_icon_get_type())
GType poppler_annot_text_icon_get_type (void) G_GNUC_CONST;

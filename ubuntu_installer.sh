...
echo 'svn update .'
svn update .
sudo apt-get install libdevil-dev libfontconfig-dev libfltk1.1-dev libdevil-dev libfreeimage-dev liblua5.1-dev libpng12-dev libboost1.42-dev lua5.1 cmake g++ libxml2-dev libogre-dev libgsl0-dev
